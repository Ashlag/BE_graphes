...
public class AStarTest	{
	...
	//Fastest path time tests, Dijkstra vs BF, condition all roads allowed
		...
		public void LengthCarOnlyInfeasible() {
			...
			//Allroads
			DijkstraAlgorithm Dijkstra = new AStarAlgorithm(dataAll);
			ShortestPathSolution solutionDijkstra = Dijkstra.run();
			...
			//CarOnly
			DijkstraAlgorithm DijkstraCar = new AStarAlgorithm(dataCar);
		...
		public void SousChemin() {
			...
			DijkstraAlgorithm DijkstraSub = new AStarAlgorithm(dataSub);
		...
		public void InegaliteTriangulaire() {
			...
			DijkstraAlgorithm DijkstraAC = new AStarAlgorithm(dataAC);
			...
			DijkstraAlgorithm DijkstraAB = new AStarAlgorithm(dataAB);
			...
			DijkstraAlgorithm DijkstraBC = new AStarAlgorithm(dataBC);
		...
		public void ShortestvsFastest() {
			...
			DijkstraAlgorithm DijkstraFast = new AStarAlgorithm(dataFast);
